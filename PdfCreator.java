...
class HeaderFooter  extends PdfPageEventHelper 
{
    ...
    public void onEndPage(PdfWriter writer, Document document) 
    {
        ...
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase("Heading",yourCustomFont),300, 810, 0);
 		...
 		try {
 			FooterImage = Image.getInstance(".\\Assets\\FooterImage.png"); 
...
public class PdfCreator  
{
	...
	PdfWriter writer ;
	String dest="OUTPUT\\ReportToday.pdf";
    ...
    writer.setPageEvent(event);
        ...
        try
        {
        	Image img = Image.getInstance(".\\ Assets\\Tourism.png");
        ...
        try
        {
             ...
             String templateInputStream =".\\Assets\\sample.pdf";  
            	// Load existing PDF
